...
set_target_properties(LLVMEosioApply PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/LLVMEosioApply.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMEosioApply )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMEosioApply "${_IMPORT_PREFIX}/lib/LLVMEosioApply.so" )
...
set_target_properties(LLVMEosioSoftfloat PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/LLVMEosioSoftfloat.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _IMPORT_CHECK_TARGETS LLVMEosioSoftfloat )
list(APPEND _IMPORT_CHECK_FILES_FOR_LLVMEosioSoftfloat "${_IMPORT_PREFIX}/lib/LLVMEosioSoftfloat.so" )
...
set_target_properties(eosio_plugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/eosio_plugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )

list(APPEND _IMPORT_CHECK_TARGETS eosio_plugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_eosio_plugin "${_IMPORT_PREFIX}/lib/eosio_plugin.so" )
